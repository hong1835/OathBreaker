...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='task_type',
            field=models.CharField(max_length=50, choices=[(b'cmd', b'CMD'), (b'multi_script', b'Script'), (b'file_send', b'\xe5\x8f\x91\xe9\x80\x81\xe6\x96\x87\xe4\xbb\xb6'), (b'file_get', b'\xe4\xb8\x8b\xe8\xbd\xbd\xe6\x96\x87\xe4\xbb\xb6')]),
        ),
        migrations.AlterField(
            model_name='tasklog',
            name='task_type',

...
class Tag(models.Model):
    ...
    creator = models.ForeignKey('hosts.UserProfile')
    create_date = models.DateField(auto_now_add=True)
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey('hosts.UserProfile', verbose_name=u'事件源')
    memo = models.TextField(u'备注', blank=True, null=True)
...
class NewAssetApprovalZone(models.Model):
    ...
    approved_by = models.ForeignKey('hosts.UserProfile', verbose_name=u'批准人', blank=True, null=True)

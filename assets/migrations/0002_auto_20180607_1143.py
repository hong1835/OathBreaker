...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(verbose_name='\u6240\u5c5e\u4e1a\u52a1', blank=True, to='assets.BusinessUnit', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
        ...
        migrations.AddField(
            model_name='asset',
            name='costcenter',
            field=models.ForeignKey(verbose_name='\u6210\u672c\u4e2d\u5fc3', blank=True, to='assets.CostCenter', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
        ...
        migrations.AddField(
            model_name='asset',
            name='manufactory',
            field=models.ForeignKey(verbose_name='\u4f9b\u5e94\u5546', blank=True, to='assets.Manufactory', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
